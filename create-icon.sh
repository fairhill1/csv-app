...
# Script to create an app icon from a PNG file
# Usage: ./create-icon.sh your-icon.png

if [ $# -eq 0 ]; then
    echo "Usage: ./create-icon.sh <icon-file.png>"
    echo "The PNG should be at least 1024x1024 pixels"
    exit 1
fi
...
iconutil -c icns "$ICONSET_DIR" -o "GridView.app/Contents/Resources/AppIcon.icns"

# Clean up
rm -rf "$ICONSET_DIR"

echo "Icon created successfully at GridView.app/Contents/Resources/AppIcon.icns"
